...
export const SLIDES: SlideData[] = [
  ...
  { id: 1, type: SlideType.LIMITS, title: "El Techo de Cristal de las CNNs Tradicionales", subtitle: "Limitaciones fundamentales que llevaron al desarrollo de ViT.", label: "Slide 1.0" },
...
export const REFERENCES: ReferenceItem[] = [
  { title: "Paper Original", description: "Foundational paper introducing the ViT architecture.", author: "Dosovitskiy et al. (2020) - An Image is Worth 16x16 Words", tag: "Core", icon: "article" },
  { title: "Scalability", description: "Research on scaling laws and optimization.", author: "Zhai et al. (2022) - Scaling Vision Transformers", icon: "trending_up" },
  { title: "Official Repository", description: "Official implementation source code and pre-trained models.", author: "Google Research - Vision Transformer (GitHub)", icon: "code" },
  { title: "Educational Resources", description: "Interactive tutorials and implementations.", author: "Hugging Face - Transformers Documentation", icon: "school" },
  { title: "Critical Analysis", description: "Training data-efficient image transformers & distillation.", author: "Touvron et al. (2021) - DeiT", icon: "biotech" },
];
