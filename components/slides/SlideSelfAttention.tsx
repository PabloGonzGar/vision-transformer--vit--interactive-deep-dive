        ...
        <div className="lg:col-span-7 flex flex-col gap-10">
          ...
          <div className="grid sm:grid-cols-2 gap-6">
            <div className="flex gap-4 p-5 rounded-2xl bg-white/5 border border-white/5 hover:border-primary/40 transition-all group">
              ...
              <div>
                <h3 className="font-bold mb-1">Proyección y Estructura del Tensor</h3>
                <p className="text-sm text-slate-400 leading-relaxed">La imagen se divide en cuadrados llamados parches que se convierten en vectores numéricos (tokens). Para que el modelo entienda la estructura visual, se añade un embebido de posición que indica la ubicación exacta de cada pieza dentro de la imagen</p>
              </div>
            </div>
            <div className="flex gap-4 p-5 rounded-2xl bg-white/5 border border-white/5 hover:border-primary/40 transition-all group">
              <div className="bg-primary/10 p-2 rounded-lg h-fit text-primary group-hover:scale-110 transition-transform">
              ...
              <div>
                <h3 className="font-bold mb-1">Diferencia en el Sesgo Inductivo</h3>
                <p className="text-sm text-slate-400 leading-relaxed">A diferencia de las redes convencionales que asumen relación entre píxeles cercanos, el Vision Transformer no conoce la estructura de la imagen. Por ello, debe aprender las reglas espaciales desde cero mediante un entrenamiento masivo con millones de datos.</p>
              </div>
            </div>
          </div>
        </div>
